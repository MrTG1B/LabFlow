        ...
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <Form {...form}>
           ...
           <div className="relative">
            ...
            <Button variant="outline" className="w-full" onClick={onGoogleSignUp} disabled={showSpinner}>
                {showSpinner ? <Loader2 className="animate-spin" /> : <>
                    ...
                    <path fill="#FF3D00" d="M6.306 14.ce91l6.571 4.819C14.655 15.108 18.961 13 24 13c3.059 0 5.842 1.154 7.961 3.039L38.438 10.38C34.661 7.042 29.697 5 24 5C17.643 5 12.042 7.746 8.076 11.834l-1.77-1.42z" />
