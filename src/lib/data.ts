...
export const inventory: InventoryItem[] = [
  { id: "INV001", name: "Ceramic Capacitor", type: "Capacitor", quantity: 500, unit: "pcs", location: "Bin A-2", value: "10uF" },
  { id: "INV002", name: "SMD Resistor", type: "Resistor", quantity: 2000, unit: "pcs", location: "Reel 1", value: "10k" },
  { id: "INV003", name: "Op-Amp", type: "IC", quantity: 80, unit: "pcs", location: "Bin A-3", value: "LM358" },
  { id: "INV004", name: "Header Pins", type: "Connector", quantity: 25, unit: "strips", location: "Bin C-1" },
  { id: "INV005", name: "ESP32-S3", type: "IC", quantity: 15, unit: "pcs", location: "Bin D-5", value: "WROOM-1" },
];
